...
REM --> Change directories to legacy versions if using Vegas 13 or lower.
if %vegasversion% LSS 14 (
    ...
    set YTPMVE_cs= "%ProgramFiles%\Sony\VEGAS Pro %vegasversion%.0\Script Menu\YTPMVE_VEGAS\YTPMVE.cs"
)    
